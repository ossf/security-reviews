...
* [Project Issue Tracker](https://github.com/yargs/set-blocking/issues)
* [Project Repository](https://github.com/yargs/set-blocking)
* [Package on deps.dev](https://deps.dev/npm/set-blocking/2.0.0)
