...
* [Project Issue Tracker](https://github.com/colorjs/color-name/issues)
* [Project Repository](https://github.com/colorjs/color-name)
* [Package on deps.dev](https://deps.dev/npm/color-name/1.1.4)
