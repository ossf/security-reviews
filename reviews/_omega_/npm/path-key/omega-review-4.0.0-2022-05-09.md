...
* [Project Issue Tracker](https://github.com/sindresorhus/path-key/issues)
* [Project Repository](https://github.com/sindresorhus/path-key)
* [Package on deps.dev](https://deps.dev/npm/path-key/4.0.0)
