...
* [Project Issue Tracker](https://github.com/sindresorhus/path-exists/issues)
* [Project Repository](https://github.com/sindresorhus/path-exists)
* [Package on deps.dev](https://deps.dev/npm/path-exists/3.0.0)
